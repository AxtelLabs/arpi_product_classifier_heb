...
class Combobox_Autocomplete(Entry, object):
    def __init__(self, master, list_of_items=None, autocomplete_function=None, listbox_width=380, listbox_height=5, ignorecase_match=False, startswith_match=False, vscrollbar=True, hscrollbar=True, **kwargs):
        ...
        Entry.__init__(self, master, **kwargs, width=40, font="Helvetica")
    ...
    def _build_listbox(self, values):
        ...
        self._listbox = Listbox(listbox_frame, background="#e6e6e6", fg="#666666", font="Helvetica",selectmode=SINGLE, activestyle="none", exportselection=False)
...
if __name__ == '__main__':
    ...
    df1 = list(df['Producto'].unique())
    #df2 = list(df['PLU'].unique())
    list_of_items =  df1 

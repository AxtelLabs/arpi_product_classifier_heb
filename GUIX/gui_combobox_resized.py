...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.vid = ("WIN_20200420_19_26_24_Pro.mp4")
        MyVideoCapture(self.vid) # <-- Changed in final version
        ...
        w0, h0 = self.img.size
        self.img= self.img.resize((int(alpha*w0/6),int(alpha*h0/6)), PIL.Image.ANTIALIAS)
        self.img= PIL.ImageTk.PhotoImage(self.img)
        self.img2= PIL.Image.open(path + "imgs/background.jpg")
        w00, h00 = self.img2.size
        self.img2= self.img2.resize((int(alpha*w00/0.8),int(alpha*h00/0.8)), PIL.Image.ANTIALIAS)
        self.img2= PIL.ImageTk.PhotoImage(self.img2)
        self.can2 = tk.Canvas(self, width=int(alpha*WIDTH/3), height=int(alpha*HEIGHT/3), bg='#000000')
        ...
        self.vidCont.place(relx=.09, rely= .25, width=int(alpha*WIDTH/2) , height=int(alpha*HEIGHT/4))
        ...
        w1, h1 = self.img3.size
        self.img3= self.img3.resize((int(alpha*w1/6),int(alpha*h1/6)), PIL.Image.ANTIALIAS)
        self.img3= PIL.ImageTk.PhotoImage(self.img3)

        # HEB logo
        self.logoRaw= PIL.Image.open(path + "imgs/logo.png")
        w2, h2 = self.logoRaw.size
        self.logoRaw= self.logoRaw.resize((int(alpha*w2/16),int(alpha*h2/16)), PIL.Image.ANTIALIAS)
        ...
        w3, h3 = self.anim1Raw.size
        self.anim1Raw= self.anim1Raw.resize((int(alpha*w3/2),int(alpha*h3/2)), PIL.Image.ANTIALIAS)
        ...
        w4, h4 = self.inst1Raw.size
        self.inst1Raw= self.inst1Raw.resize((int(alpha*w4/3),int(alpha*h4/3)), PIL.Image.ANTIALIAS)
        ...
        w5, h5 = self.inst2Raw.size
        self.inst2Raw= self.inst2Raw.resize((int(alpha*w5/3),int(alpha*h5/3)), PIL.Image.ANTIALIAS)
        ...
        w6, h6 = self.inst3Raw.size
        self.inst3Raw= self.inst3Raw.resize((int(alpha*w6/7),int(alpha*h6/7)), PIL.Image.ANTIALIAS)

        self.inst3= PIL.ImageTk.PhotoImage(self.inst3Raw)
        
        self.detMsg = self.can2.create_image((int(alpha*w6/7),int(alpha*h6/7)), image=self.inst3)
        self.inst4Raw= PIL.Image.open(path + "imgs/inst4.png")
        
        w8, h8 = self.inst4Raw.size
        self.inst4Raw= self.inst4Raw.resize((int(alpha*w8/7),int(alpha*h8/7)), PIL.Image.ANTIALIAS)
        self.inst4= PIL.ImageTk.PhotoImage(self.inst4Raw)

        # Instructions 5
        self.inst5Raw= PIL.Image.open(path + "imgs/inst5.png")
        
        w9, h9 = self.inst5Raw.size
        self.inst5Raw= self.inst5Raw.resize((int(alpha*w9/4),int(alpha*h9/4)), PIL.Image.ANTIALIAS)
        self.inst5= PIL.ImageTk.PhotoImage(self.inst5Raw)
        self.lastMsg = self.can2.create_image((int(alpha*WIDTH/3),int(alpha*HEIGHT/2)), image=self.inst5)
...
class PageTwo(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Import images
        self.img= PIL.Image.open(path + "imgs/transparent.png")
        w10, h10 = self.img.size
        self.img= self.img.resize((int(alpha*w10/6),int(alpha*h10/6)), PIL.Image.ANTIALIAS)
        self.img= PIL.ImageTk.PhotoImage(self.img)
        self.img2= PIL.Image.open(path + "imgs/background.jpg")
        w11, h11 = self.img2.size
        self.img2= self.img2.resize((int(alpha*w11/0.8),int(alpha*h11/0.8)), PIL.Image.ANTIALIAS)
        self.img2= PIL.ImageTk.PhotoImage(self.img2)
        ...
        # HEB logo
        self.logoRaw= PIL.Image.open(path + "imgs/logo.png")
        w12, h12 = self.logoRaw.size
        self.logoRaw= self.logoRaw.resize((int(alpha*w12/16),int(alpha*h12/16)), PIL.Image.ANTIALIAS)
        self.logo= PIL.ImageTk.PhotoImage(self.logoRaw)
        self.label1= tk.Label(self, background= "#ffffff", image= self.logo)
        self.label1.place (relx=-0.03, rely=.02, relwidth= .2, relheight=.07)
        self.label1.image=self.logo
        ...
        w13, h13 = self.uno.size
        self.uno= self.uno.resize((int(alpha*w13/4),int(alpha*h13/4)), PIL.Image.ANTIALIAS)
        ...
        w14, h14 = self.anim1Raw.size
        self.anim1Raw= self.anim1Raw.resize((int(alpha*w14/2),int(alpha*h14/2)), PIL.Image.ANTIALIAS)
        self.anim1= PIL.ImageTk.PhotoImage(self.anim1Raw)
        self.label3= tk.Label(self, background= "#FFFFFF", image= self.anim1) 
        ...
        w15, h15 = self.dos.size
        self.dos= self.dos.resize((int(alpha*w15/4),int(alpha*h15/4)), PIL.Image.ANTIALIAS)
        ...
        self.option1= self.option1.resize((int(alpha*WIDTH/4),int(alpha*HEIGHT/4)), PIL.Image.ANTIALIAS)
        ...
        self.option2= self.option2.resize((int(alpha*WIDTH/6),int(alpha*HEIGHT/6)), PIL.Image.ANTIALIAS)
        ...
        self.option3= self.option3.resize((int(alpha*WIDTH/6),int(alpha*HEIGHT/6)), PIL.Image.ANTIALIAS)
        ...
        self.option4= self.option4.resize((int(alpha*WIDTH/6),int(alpha*HEIGHT/6)), PIL.Image.ANTIALIAS)
        ...
        w16, h16 = self.dos.size
        self.dos= self.dos.resize((int(alpha*w16/6),int(alpha*h16/6)), PIL.Image.ANTIALIAS)
        self.dosre=PIL.ImageTk.PhotoImage(self.dos)
        self.lastMsg = self.can2.create_image((int(alpha*WIDTH/4),int(alpha*HEIGHT/2)), image=self.dosre)


        # Finish image
        self.finish= PIL.Image.open(path + "imgs/finish.png")
        w17, h17 = self.finish.size
        self.finish= self.finish.resize((int(alpha*w17/3),int(alpha*h17/3)), PIL.Image.ANTIALIAS)
        self.finishre=PIL.ImageTk.PhotoImage(self.finish)
        self.finishMsg = self.can2.create_image(int(alpha*WIDTH/2.6),int(alpha*HEIGHT/2.5), image=self.finishre)
        ...
        w18, h18 = self.search.size
        self.search= self.search.resize((int(alpha*w18/4),int(alpha*h18/4)), PIL.Image.ANTIALIAS)
        self.searchre=PIL.ImageTk.PhotoImage(self.search)
        self.searchMsg = self.can2.create_image(int(alpha*WIDTH/2.6),int(alpha*HEIGHT/1.75), image=self.searchre)
    ...
    def updateImgs(self):
        ...
        ## Image
        self.option1= PIL.Image.open(self.DictReturn[0]["path"])
        self.option1= self.option1.resize((int(alpha*WIDTH/6),int(alpha*HEIGHT/6)), PIL.Image.ANTIALIAS)
        self.option1re=PIL.ImageTk.PhotoImage(self.option1)
...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # Import images
        self.img= PIL.Image.open(path + "imgs/transparent.png")
        w19, h19 = self.img.size
        self.img= self.img.resize((int(alpha*w19/6),int(alpha*h19/6)), PIL.Image.ANTIALIAS)
        self.img= PIL.ImageTk.PhotoImage(self.img)
        self.img2= PIL.Image.open(path + "imgs/background.jpg")
        w20, h20 = self.img2.size
        self.img2= self.img2.resize((int(alpha*w20/0.8),int(alpha*h20/0.8)), PIL.Image.ANTIALIAS)
        self.img2= PIL.ImageTk.PhotoImage(self.img2)
        self.can2 = tk.Canvas(self, width=WIDTH/2, height=HEIGHT, bg='#000000')
        self.can2.place(relx=0.5, rely=0 ,relwidth=1, relheight=1)
        ...
        skip = 45
        skip2 = 75
        self.keyWidth = int(63*beta)
        self.keyHeight = int(69*beta)
        row = 60
        col = 60
        row3 = 95
        skip3 = 70
        ...
        self.lastMsgQ= self.keyboardCanvas.create_image(row,col, image=self.buttonQ)
        # -- Binds
        ...
        self.lastMsgW= self.keyboardCanvas.create_image(row+skip,col, image=self.buttonW)
        # -- Binds
        ...
        self.lastMsgE= self.keyboardCanvas.create_image(row+2*skip,col, image=self.buttonE)
        # -- Binds
        ...
        self.lastMsgR= self.keyboardCanvas.create_image(row+3*skip,col, image=self.buttonR)
        # -- Binds
        ...
        self.lastMsgT= self.keyboardCanvas.create_image(row+4*skip,col, image=self.buttonT)
        # -- Binds
        ...
        self.lastMsgY= self.keyboardCanvas.create_image(row+5*skip,col, image=self.buttonY)
        # -- Binds
        ...
        self.lastMsgU= self.keyboardCanvas.create_image(row+6*skip,col, image=self.buttonU)
        # -- Binds
        ...
        self.lastMsgI= self.keyboardCanvas.create_image(row+7*skip,col, image=self.buttonI)
        # -- Binds
        ...
        self.lastMsgO= self.keyboardCanvas.create_image(row+8*skip,col, image=self.buttonO)
        # -- Binds
        ...
        self.lastMsgP= self.keyboardCanvas.create_image(row+9*skip,col, image=self.buttonP)
        # -- Binds
        ...
        ## DEL (BACKSPACE)
        # -- Images
        self.buttonDEL = process_image(imgPath + "normal_buttons/delete.png",2*row+25,col)
        self.buttonDEL_pressed = process_image(imgPath + "normal_buttons/deletep.png",2*row+25,col)
        self.lastMsgDEL= self.keyboardCanvas.create_image(row+12*skip,col, image=self.buttonDEL)
        # -- Binds
        ...
        self.lastMsgA= self.keyboardCanvas.create_image(skip2,col+col, image=self.buttonA)
        # -- Binds
        ...
        self.lastMsgS= self.keyboardCanvas.create_image(2*row,col+col, image=self.buttonS)
        # -- Binds
        ...
        self.lastMsgD= self.keyboardCanvas.create_image(3*row-15,col+col, image=self.buttonD)
        # -- Binds
        ...
        self.lastMsgF= self.keyboardCanvas.create_image(4*row-15*2,col+col, image=self.buttonF)
        # -- Binds
        ...
        self.lastMsgG= self.keyboardCanvas.create_image(5*row-15*3,col+col, image=self.buttonG)
        # -- Binds
        ...
        self.lastMsgH= self.keyboardCanvas.create_image(6*row-15*4,col+col, image=self.buttonH)
        # -- Binds
        ...
        self.lastMsgJ= self.keyboardCanvas.create_image(7*row-15*5,col+col, image=self.buttonJ)
        # -- Binds
        ...
        self.lastMsgK= self.keyboardCanvas.create_image(8*row-15*6,col+col, image=self.buttonK)
        # -- Binds
        ...
        self.lastMsgL= self.keyboardCanvas.create_image(9*row-15*7,col+col, image=self.buttonL)
        # -- Binds
        ...
        ## RET
        # -- Images
        self.buttonRET = process_image(imgPath + "normal_buttons/return.png",150,90)
        self.buttonRET_pressed = process_image(imgPath + "normal_buttons/returnp.png",150,90)
        self.lastMsgRET= self.keyboardCanvas.create_image(10*row-25,150, image=self.buttonRET)
        ...
        self.lastMsgÑ= self.keyboardCanvas.create_image(10*row-15*8,col+col, image=self.buttonÑ)
        # -- Binds
        ...
        self.lastMsgZ= self.keyboardCanvas.create_image(row3,3*col, image=self.buttonZ)
        # -- Binds
        ...
        self.lastMsgX= self.keyboardCanvas.create_image(row3+45,3*col, image=self.buttonX)
        # -- Binds
        ...
        self.lastMsgC= self.keyboardCanvas.create_image(row3+90,3*col, image=self.buttonC)
        # -- Binds
        ...
        self.lastMsgV= self.keyboardCanvas.create_image(row3+135,3*col, image=self.buttonV)
        # -- Binds
        ...
        self.lastMsgB= self.keyboardCanvas.create_image(row3+180,3*col, image=self.buttonB)
        # -- Binds
        ...
        self.lastMsgN= self.keyboardCanvas.create_image(row3+225,3*col, image=self.buttonN)
        # -- Binds
        ...
        self.lastMsgM= self.keyboardCanvas.create_image(row3+270,3*col, image=self.buttonM)
        # -- Binds
        ...
        self.lastMsgCOMM= self.keyboardCanvas.create_image(row3+315,3*col, image=self.buttonCOMM)
        # -- Binds
        ...
        self.lastMsgDOT= self.keyboardCanvas.create_image(row3+360,3*col, image=self.buttonDOT)
        # -- Binds
        ...
        ## SPACEBAR
        # -- Images
        self.instSPACE = process_image(imgPath + "normal_buttons/spacebar.png",385,int(col/2))
        self.instSPACE_pressed = process_image(imgPath + "normal_buttons/spacep.png",385,int(col/2))
        self.lastMsgSPACE= self.keyboardCanvas.create_image(305,235, image=self.instSPACE)
        # -- Binds
        ...
        # HEB logo
        self.logoRaw= PIL.Image.open(path + "imgs/logo.png")
        w21, h21 = self.logoRaw.size
        self.logoRaw= self.logoRaw.resize((int(alpha*w21/16),int(alpha*h21/16)), PIL.Image.ANTIALIAS)
        self.logo= PIL.ImageTk.PhotoImage(self.logoRaw)
        self.label1= tk.Label(self, background= "#ffffff", image= self.logo)
        self.label1.place (relx=-0.03, rely=.02, relwidth= .2, relheight=.07)
        self.label1.image=self.logo
        ...
        # Instructions 1 P3
        self.uno= PIL.Image.open(path + "imgs/P3_1BasedeDa.PNG")
        w22, h22 = self.uno.size
        self.uno= self.uno.resize((int(alpha*w22/2),int(alpha*h22/2)), PIL.Image.ANTIALIAS)
        self.unore=PIL.ImageTk.PhotoImage(self.uno)
        self.label4= tk.Label(self.can, background="#FFFFFF", image= self.unore)
        self.label4.place(relx=0.02, rely=0.12 ,relwidth=0.4, relheight=.16)
        self.label4.image= self.unore      

        # Animated Instructions P3
        self.anim1Raw= PIL.Image.open(path + "imgs/label.png")
        w23, h23 = self.anim1Raw.size
        self.anim1Raw= self.anim1Raw.resize((int(alpha*w23/2),int(alpha*h23/2)), PIL.Image.ANTIALIAS)
        self.anim1= PIL.ImageTk.PhotoImage(self.anim1Raw)
        self.label3= tk.Label(self, background= "#FFFFFF", image= self.anim1) 
        self.label3.place (relx=0.12, rely=.35, relwidth= .3, relheight=.33)
        self.label3.image=self.anim1
        ...
        # Instructions 2 P3
        self.dos= PIL.Image.open(path + "imgs/P3_2rec.png")
        w24, h24 = self.dos.size
        self.dos= self.dos.resize((int(alpha*w24/1.5),int(alpha*h24/1.5)), PIL.Image.ANTIALIAS)
        self.dosre=PIL.ImageTk.PhotoImage(self.dos)
        self.label4= tk.Label(self.can, background="#FFFFFF", image= self.dosre)
        self.label4.place(relx=0.051, rely=0.65,relwidth=0.45, relheight=.20)
        self.label4.image= self.dosre
        ...
        # Instructions 3 
        self.inst3Raw= PIL.Image.open(path + "imgs/buscar.png")
        w25, h25 = self.inst3Raw.size
        self.inst3Raw= self.inst3Raw.resize((int(alpha*w25/6),int(alpha*h25/6)), PIL.Image.ANTIALIAS)
        self.inst3= PIL.ImageTk.PhotoImage(self.inst3Raw)
        self.detMsg = self.can2.create_image(int(alpha*WIDTH/3.75),int(alpha*HEIGHT/14), image=self.inst3)

        # Finish image
        self.finish= PIL.Image.open(path + "imgs/finish.png")
        w26, h26 = self.finish.size
        self.finish= self.finish.resize((int(alpha*w26/3),int(alpha*h26/3)), PIL.Image.ANTIALIAS)
        self.finishre=PIL.ImageTk.PhotoImage(self.finish)
        self.finishMsg = self.can2.create_image(int(alpha*WIDTH/2.3),int(alpha*HEIGHT/3), image=self.finishre)
        self.can2.tag_bind(self.finishMsg, '<Button-1>', lambda b: self.controller.show_frame("PageOne"))

...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # Keyboard canvas
        self.can3 = tk.Canvas(self, width=WIDTH, height=(HEIGHT)/2, bg='#C2C8D3')
        ...
        # Create new keyboard buttons
        self.imgX= PIL.Image.open(path + "imgs/buttonA.png")
        self.imgX= self.imgX.resize((110,112), PIL.Image.ANTIALIAS)
        self.imgX= PIL.ImageTk.PhotoImage(self.imgX)
        self.can3.create_image(100,100, image=self.imgX)

        self.imgS= PIL.Image.open(path + "imgs/buttonS.png")
        self.imgS= self.imgS.resize((110,112), PIL.Image.ANTIALIAS)
        self.imgS= PIL.ImageTk.PhotoImage(self.imgS)
        self.can3.create_image(215,100, image=self.imgS)

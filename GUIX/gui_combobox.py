...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.img= self.img.resize((int(alpha*WIDTH/6),int(alpha*HEIGHT/6)), PIL.Image.ANTIALIAS)
        ...
        self.logoRaw= self.logoRaw.resize((int(alpha*WIDTH/6),int(alpha*HEIGHT/6)), PIL.Image.ANTIALIAS)
...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.dos= self.dos.resize((450,110), PIL.Image.ANTIALIAS)
        self.dosre=PIL.ImageTk.PhotoImage(self.dos)
        self.label4= tk.Label(self.can, background="#FFFFFF", image= self.dosre)
        self.label4.place(relx=0.051, rely=0.65,relwidth=0.45, relheight=.20)
        self.label4.image= self.dosre
        ...
        self.finish= self.finish.resize((500,140), PIL.Image.ANTIALIAS)
        self.finishre=PIL.ImageTk.PhotoImage(self.finish)
        self.finishMsg = self.can2.create_image(300,230, image=self.finishre)
        self.can2.tag_bind(self.finishMsg, '<Button-1>', lambda b: self.controller.show_frame("PageOne"))
